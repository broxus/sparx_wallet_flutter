...
Map<String, dynamic> _$ConnectionConfigToJson(
  ...
  'startConnections': instance.startConnections.map((e) => e.toJson()).toList(),
  'customNetworkOptions': instance.customNetworkOptions
      .map((e) => e.toJson())
      .toList(),
};
