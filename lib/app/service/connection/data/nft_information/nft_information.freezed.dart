...
extension NftInformationPatterns on NftInformation {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NftInformation value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? marketplaceUrl, List<Address>? defaultCollections)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _NftInformation() when $default != null:
        return $default(_that.marketplaceUrl, _that.defaultCollections);
      case _:
        return orElse();
    }
  }
