...
TonConnectWidgetModel defaultTonConnectWidgetModelFactory(
  BuildContext context,
) =>
    TonConnectWidgetModel(
      TonConnectModel(
...
class TonConnectWidgetModel
    extends CustomWidgetModel<TonConnectWidget, TonConnectModel> {
  TonConnectWidgetModel(super.model);
