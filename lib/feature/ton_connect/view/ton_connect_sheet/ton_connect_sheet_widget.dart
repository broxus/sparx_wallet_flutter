...
class TonConnectWidget extends ElementaryWidget<TonConnectWidgetModel> {
  const TonConnectWidget({
    required this.request,
    required this.scrollController,
    Key? key,
    WidgetModelFactory wmFactory = defaultTonConnectWidgetModelFactory,
  ...
  @override
  Widget build(TonConnectWidgetModel wm) => ValueListenableBuilder(
...
class _SelectAccountWidget extends StatelessWidget {
  ...
  final TonConnectWidgetModel wm;
  final ScrollController scrollController;
