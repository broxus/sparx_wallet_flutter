...
extension TonProofPatterns on TonProof {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TonProof value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String timestamp, String signature, String payload,
            TonProofDomain domain)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _TonProof() when $default != null:
        return $default(
            _that.timestamp, _that.signature, _that.payload, _that.domain);
      case _:
        return orElse();
    }
  }
