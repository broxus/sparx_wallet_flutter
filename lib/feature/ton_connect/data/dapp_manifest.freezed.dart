...
extension DappManifestPatterns on DappManifest {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DappManifest value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String url, String name, String iconUrl,
            String? termsOfUseUrl, String? privacyPolicyUrl)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _DappManifest() when $default != null:
        return $default(_that.url, _that.name, _that.iconUrl,
            _that.termsOfUseUrl, _that.privacyPolicyUrl);
      case _:
        return orElse();
    }
  }
