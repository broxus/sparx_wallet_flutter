...
mixin _$TransactionPayload {
 ...
 List<TransactionPayloadMessage> get messages;@ValidUntilSecondsConverter()@JsonKey(name: 'valid_until', disallowNullValue: true) int? get validUntil; TonNetwork? get network; Address? get from;
...
@useResult
$Res call({
 List<TransactionPayloadMessage> messages,@ValidUntilSecondsConverter()@JsonKey(name: 'valid_until', disallowNullValue: true) int? validUntil, TonNetwork? network, Address? from
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<TransactionPayloadMessage> messages, @ValidUntilSecondsConverter()@JsonKey(name: 'valid_until', disallowNullValue: true)  int? validUntil,  TonNetwork? network,  Address? from)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransactionPayload() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<TransactionPayloadMessage> messages, @ValidUntilSecondsConverter()@JsonKey(name: 'valid_until', disallowNullValue: true)  int? validUntil,  TonNetwork? network,  Address? from)  $default,) {final _that = this;
switch (_that) {
case _TransactionPayload():
return $default(_that.messages,_that.validUntil,_that.network,_that.from);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<TransactionPayloadMessage> messages, @ValidUntilSecondsConverter()@JsonKey(name: 'valid_until', disallowNullValue: true)  int? validUntil,  TonNetwork? network,  Address? from)?  $default,) {final _that = this;
switch (_that) {
case _TransactionPayload() when $default != null:
return $default(_that.messages,_that.validUntil,_that.network,_that.from);case _:
  return null;
...
class _TransactionPayload implements TransactionPayload {
   _TransactionPayload({required final  List<TransactionPayloadMessage> messages, @ValidUntilSecondsConverter()@JsonKey(name: 'valid_until', disallowNullValue: true) this.validUntil, this.network, this.from}): _messages = messages;
...
@override@ValidUntilSecondsConverter()@JsonKey(name: 'valid_until', disallowNullValue: true) final  int? validUntil;
