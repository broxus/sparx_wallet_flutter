...
extension SignDataResultPatterns on SignDataResult {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SignDataResult value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String signature, String timestamp)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SignDataResult() when $default != null:
        return $default(_that.signature, _that.timestamp);
      case _:
        return orElse();
    }
  }
