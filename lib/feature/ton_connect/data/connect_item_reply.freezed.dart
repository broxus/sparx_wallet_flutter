...
extension ConnectItemReplyPatterns on ConnectItemReply {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case TonProofItemReplySuccess() when tonProofSuccess != null:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case TonAddressItemReply() when tonAddress != null:
        return tonAddress(_that.address, _that.network, _that.publicKey,
            _that.walletStateInit);
      case TonProofItemReplySuccess() when tonProofSuccess != null:
