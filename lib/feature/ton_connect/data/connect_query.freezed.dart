...
extension ConnectQueryPatterns on ConnectQuery {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConnectQuery value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String v, String r, String id, String ret)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ConnectQuery() when $default != null:
        return $default(_that.v, _that.r, _that.id, _that.ret);
      case _:
        return orElse();
    }
  }
