...
extension SignDataPayloadPatterns on SignDataPayload {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SignDataPayload value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: 'schema_crc') int schema, String cell,
            PublicKey? publicKey)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _SignDataPayload() when $default != null:
        return $default(_that.schema, _that.cell, _that.publicKey);
      case _:
        return orElse();
    }
  }
