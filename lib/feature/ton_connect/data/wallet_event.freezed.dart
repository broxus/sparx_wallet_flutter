...
extension WalletEventPatterns on WalletEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case ConnectEventSuccess() when connectSuccess != null:
        return connectSuccess(_that);
      case ConnectEventError() when connectError != null:
        return connectError(_that);
      case DisconnectEvent() when disconnect != null:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case ConnectEventSuccess() when connectSuccess != null:
        return connectSuccess(_that.id, _that.payload);
      case ConnectEventError() when connectError != null:
        return connectError(_that.id, _that.payload);
      case DisconnectEvent() when disconnect != null:
