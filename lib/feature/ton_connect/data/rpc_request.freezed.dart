...
extension RpcRequestPatterns on RpcRequest {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case SendTransactionRpcRequest() when sendTransaction != null:
        return sendTransaction(_that);
      case SignDataRpcRequest() when signData != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case DisconnectRpcRequest():
        return disconnect(_that);
      case SendTransactionRpcRequest():
        return sendTransaction(_that);
      case SignDataRpcRequest():
        return signData(_that);
    }
  }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case DisconnectRpcRequest() when disconnect != null:
        return disconnect(_that.id, _that.params);
      case SendTransactionRpcRequest() when sendTransaction != null:
        return sendTransaction(_that.id, _that.params);
      case SignDataRpcRequest() when signData != null:
