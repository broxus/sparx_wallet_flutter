...
extension PendingNftPatterns on PendingNft {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PendingNft value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, Address collection, NetworkGroup networkGroup,
            Address owner)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _PendingNft() when $default != null:
        return $default(
            _that.id, _that.collection, _that.networkGroup, _that.owner);
      case _:
        return orElse();
    }
  }
