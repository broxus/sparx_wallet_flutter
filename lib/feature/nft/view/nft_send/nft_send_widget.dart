...
class NftSendWidget
    extends
        InjectedElementaryParametrizedWidget<
          ...
          NftSendRouteData
        > {
  const NftSendWidget({required this.data, super.key})
    ...
    return StateNotifierBuilder(
      ...
      builder: (_, state) {
        ...
        final appBar = switch (state) {
          ...
          NftSendStateError() => DefaultAppBar(
        ...
        final body = switch (state) {
          NftSendStateError(:final error) => Center(
          ...
          NftSendStateReady() => Padding(
            ...
            child: NftSendConfirm(
              ...
              account: wm.account,
              amount: data.amount,
              feesState: wm.feesState,
              errorState: wm.errorState,
              txErrorsState: wm.txErrorsState,
              loadingState: wm.loadingState,
