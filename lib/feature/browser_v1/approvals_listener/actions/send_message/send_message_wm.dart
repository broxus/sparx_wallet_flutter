...
@injectable
class SendMessageWidgetModel extends InjectedWidgetModel<SendMessageWidget,
    SendMessageModel, SendMessageWmParams> {
  ...
  late final _recipient = createWmParamsNotifier(
    (it) => it.recipient,
  );

  late final _payload = createWmParamsNotifier(
    (it) => it.payload,
  );

  ValueListenable<Uri> get origin => _origin;
  ValueListenable<Address> get recipient => _recipient;
  ValueListenable<FunctionCall?> get payload => _payload;
