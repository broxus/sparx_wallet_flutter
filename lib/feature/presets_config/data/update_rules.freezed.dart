...
extension UpdateRulesPatterns on UpdateRules {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UpdateRules value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String blockingVersion, String warningVersion,
            int warningShowTimes, int warningShowDelayS)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UpdateRules() when $default != null:
        return $default(_that.blockingVersion, _that.warningVersion,
            _that.warningShowTimes, _that.warningShowDelayS);
      case _:
        return orElse();
    }
  }
