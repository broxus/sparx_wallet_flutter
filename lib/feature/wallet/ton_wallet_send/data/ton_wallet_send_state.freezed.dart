  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case TonWalletSendStateError() when error != null:
        return error(_that);
      case TonWalletSendStateReady() when ready != null:
        return ready(_that);
      case TonWalletSendStateSending() when sending != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case TonWalletSendStateError():
        return error(_that);
      case TonWalletSendStateReady():
        return ready(_that);
      case TonWalletSendStateSending():
        return sending(_that);
    }
  }
