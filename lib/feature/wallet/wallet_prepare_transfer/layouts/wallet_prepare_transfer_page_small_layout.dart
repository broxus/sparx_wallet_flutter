...
class WalletPrepareTransferPageSmallLayout extends StatelessWidget {
  const WalletPrepareTransferPageSmallLayout(
    this._wm, {
    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: [
          SliverList.list(
            children: [
              DefaultAppBar(titleText: LocaleKeys.sendYourFunds.tr()),
              Padding(
