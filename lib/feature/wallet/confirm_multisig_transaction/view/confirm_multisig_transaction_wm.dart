...
@injectable
class ConfirmMultisigTransactionWidgetModel extends InjectedWidgetModel<
  ...
  late final KeyAccount? account =
      model.getAccount(_walletAddress);
  ...
  Future<void> onCustodianSelected(PublicKey custodian) async {
    ...
    try {
      ...
      final walletState =
          await model.getWalletState(_walletAddress);
