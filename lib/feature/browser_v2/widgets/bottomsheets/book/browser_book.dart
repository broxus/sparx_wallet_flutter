...
import 'package:app/feature/browser_v2/widgets/bottomsheets/book/widgets/bookmarks/book_item.dart';
import 'package:app/feature/browser_v2/widgets/bottomsheets/book/widgets/bookmarks/bookmarks_empty.dart';
import 'package:app/feature/browser_v2/widgets/bottomsheets/book/widgets/history/date_item.dart';
import 'package:app/feature/browser_v2/widgets/bottomsheets/book/widgets/history/history_empty.dart';
            ...
            return PrimaryBottomSheetContainerBox(
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  BookSearch(
                    searchVisibleState: wm.searchVisibleState,
            ...
            builder: (_, BrowserBookTabBarValue? value) {
              return switch (value) {
                ...
                BrowserBookTabBarValue.history => HistoryBookmarksMenu(
                    editState: wm.historyDelegate.editState,
                    activeState: wm.historyDelegate.activeMenuState,
