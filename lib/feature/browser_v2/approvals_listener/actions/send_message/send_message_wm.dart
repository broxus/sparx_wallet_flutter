...
import 'package:app/feature/browser_v2/approvals_listener/actions/send_message/send_message_model.dart';
import 'package:app/feature/browser_v2/approvals_listener/actions/send_message/send_message_widget.dart';
...
class SendMessageWidgetModel
  ...
  late final _recipientState = createWmParamsNotifier((it) => it.recipient);
  ...
  Future<void> _getCustodians() async {
    final custodians = await model.getLocalCustodiansAsync(
      wmParams.value.sender,
    );
