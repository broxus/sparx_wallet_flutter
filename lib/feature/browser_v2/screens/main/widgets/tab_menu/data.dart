...
enum BrowserTabMenuItemData {
  copyLink(icon: LucideIcons.copy),
  pinTab(icon: LucideIcons.pin),
  bookmark(icon: LucideIcons.bookmark),
  newTabGroup(icon: LucideIcons.plus);

  const BrowserTabMenuItemData({required this.icon});
