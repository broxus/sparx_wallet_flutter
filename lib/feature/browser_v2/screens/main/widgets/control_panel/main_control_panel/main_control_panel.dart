import 'package:app/feature/browser_v2/screens/main/widgets/control_panel/main_control_panel/main_control_panel_wm.dart';
...
class BrowserMainControlPanel
    extends ElementaryWidget<BrowserMainControlPanelWidgetModel> {
  const BrowserMainControlPanel({
    required this.onPressedTabs,
    super.key,
    WidgetModelFactory<BrowserMainControlPanelWidgetModel> wmFactory =
  ...
  @override
  Widget build(BrowserMainControlPanelWidgetModel wm) {
    return SizedBox(
      height: height,
      child: Row(
        children: [
