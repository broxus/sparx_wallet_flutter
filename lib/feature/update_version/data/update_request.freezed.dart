...
/// The status of the update (blocking, warning, none)
 UpdateStatus get status;/// The target version to update to
 String? get targetVersion;/// Optional release notes for the target version
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateRequest&&(identical(other.status, status) || other.status == status)&&(identical(other.targetVersion, targetVersion) || other.targetVersion == targetVersion)&&(identical(other.releaseNote, releaseNote) || other.releaseNote == releaseNote));
}


@override
int get hashCode => Object.hash(runtimeType,status,targetVersion,releaseNote);
...
/// Create a copy of UpdateRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? targetVersion = freezed,Object? releaseNote = freezed,}) {
  return _then(_self.copyWith(
status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as UpdateStatus,targetVersion: freezed == targetVersion ? _self.targetVersion : targetVersion // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UpdateStatus status,  String? targetVersion,  ReleaseNote? releaseNote)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateRequest() when $default != null:
return $default(_that.status,_that.targetVersion,_that.releaseNote);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UpdateStatus status,  String? targetVersion,  ReleaseNote? releaseNote)  $default,) {final _that = this;
switch (_that) {
case _UpdateRequest():
return $default(_that.status,_that.targetVersion,_that.releaseNote);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UpdateStatus status,  String? targetVersion,  ReleaseNote? releaseNote)?  $default,) {final _that = this;
switch (_that) {
case _UpdateRequest() when $default != null:
return $default(_that.status,_that.targetVersion,_that.releaseNote);case _:
  return null;
...
class _UpdateRequest implements UpdateRequest {
  const _UpdateRequest({required this.status, this.targetVersion, this.releaseNote});
  

/// The status of the update (blocking, warning, none)
@override final  UpdateStatus status;
/// The target version to update to
@override final  String? targetVersion;
/// Optional release notes for the target version
@override final  ReleaseNote? releaseNote;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UpdateRequest&&(identical(other.status, status) || other.status == status)&&(identical(other.targetVersion, targetVersion) || other.targetVersion == targetVersion)&&(identical(other.releaseNote, releaseNote) || other.releaseNote == releaseNote));
}
...
@override $ReleaseNoteCopyWith<$Res>? get releaseNote;
...
/// Create a copy of UpdateRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? targetVersion = freezed,Object? releaseNote = freezed,}) {
