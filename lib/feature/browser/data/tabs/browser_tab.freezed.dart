...
/// The id of the tab.
 String get id;/// Initial url of the tab.
 Uri get url;/// Initial url of the tab.
 set url(Uri value);/// The title of the tab.
 String? get title;/// The title of the tab.
 set title(String? value);/// The sorting position of the tab.
 double get sortingOrder;/// The sorting position of the tab.
...
@useResult
$Res call({
 String id, Uri url, String? title, double sortingOrder
});
...
/// Create a copy of BrowserTab
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? url = null,Object? title = freezed,Object? sortingOrder = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  Uri url,  String? title,  double sortingOrder)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BrowserTab() when $default != null:
return $default(_that.id,_that.url,_that.title,_that.sortingOrder);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  Uri url,  String? title,  double sortingOrder)  $default,) {final _that = this;
switch (_that) {
case _BrowserTab():
return $default(_that.id,_that.url,_that.title,_that.sortingOrder);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  Uri url,  String? title,  double sortingOrder)?  $default,) {final _that = this;
switch (_that) {
case _BrowserTab() when $default != null:
return $default(_that.id,_that.url,_that.title,_that.sortingOrder);case _:
  return null;
...
class _BrowserTab extends BrowserTab {
   _BrowserTab({required this.id, required this.url, required this.title, required this.sortingOrder}): super._();
  factory _BrowserTab.fromJson(Map<String, dynamic> json) => _$BrowserTabFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$BrowserTabToJson(this, );
}
...
/// Create a copy of BrowserTab
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? url = null,Object? title = freezed,Object? sortingOrder = null,}) {
