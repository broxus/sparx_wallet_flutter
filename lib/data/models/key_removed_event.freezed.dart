...
$KeyRemovedEventCopyWith<KeyRemovedEvent> get copyWith => _$KeyRemovedEventCopyWithImpl<KeyRemovedEvent>(this as KeyRemovedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is KeyRemovedEvent&&(identical(other.key, key) || other.key == key));
}
...
abstract mixin class $KeyRemovedEventCopyWith<$Res>  {
  factory $KeyRemovedEventCopyWith(KeyRemovedEvent value, $Res Function(KeyRemovedEvent) _then) = _$KeyRemovedEventCopyWithImpl;
@useResult
$Res call({
 KeyStoreEntry key
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _KeyRemovedEvent value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _KeyRemovedEvent value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _KeyRemovedEvent value)?  $default,){
final _that = this;
switch (_that) {
case _KeyRemovedEvent() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$KeyRemovedEventCopyWith<_KeyRemovedEvent> get copyWith => __$KeyRemovedEventCopyWithImpl<_KeyRemovedEvent>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _KeyRemovedEvent&&(identical(other.key, key) || other.key == key));
}
...
/// @nodoc
abstract mixin class _$KeyRemovedEventCopyWith<$Res> implements $KeyRemovedEventCopyWith<$Res> {
  factory _$KeyRemovedEventCopyWith(_KeyRemovedEvent value, $Res Function(_KeyRemovedEvent) _then) = __$KeyRemovedEventCopyWithImpl;
@override @useResult
$Res call({
 KeyStoreEntry key
});
