...
$TonAssetsManifestVersionCopyWith<TonAssetsManifestVersion> get copyWith => _$TonAssetsManifestVersionCopyWithImpl<TonAssetsManifestVersion>(this as TonAssetsManifestVersion, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TonAssetsManifestVersion&&(identical(other.major, major) || other.major == major)&&(identical(other.minor, minor) || other.minor == minor)&&(identical(other.patch, patch) || other.patch == patch));
}
...
abstract mixin class $TonAssetsManifestVersionCopyWith<$Res>  {
  factory $TonAssetsManifestVersionCopyWith(TonAssetsManifestVersion value, $Res Function(TonAssetsManifestVersion) _then) = _$TonAssetsManifestVersionCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TonAssetsManifestVersion value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TonAssetsManifestVersion value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TonAssetsManifestVersion value)?  $default,){
final _that = this;
switch (_that) {
case _TonAssetsManifestVersion() when $default != null:
return $default(_that);case _:
...
class _TonAssetsManifestVersion implements TonAssetsManifestVersion {
  const _TonAssetsManifestVersion({required this.major, required this.minor, required this.patch});
  factory _TonAssetsManifestVersion.fromJson(Map<String, dynamic> json) => _$TonAssetsManifestVersionFromJson(json);
...
@pragma('vm:prefer-inline')
_$TonAssetsManifestVersionCopyWith<_TonAssetsManifestVersion> get copyWith => __$TonAssetsManifestVersionCopyWithImpl<_TonAssetsManifestVersion>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TonAssetsManifestVersionToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TonAssetsManifestVersion&&(identical(other.major, major) || other.major == major)&&(identical(other.minor, minor) || other.minor == minor)&&(identical(other.patch, patch) || other.patch == patch));
}
...
/// @nodoc
abstract mixin class _$TonAssetsManifestVersionCopyWith<$Res> implements $TonAssetsManifestVersionCopyWith<$Res> {
  factory _$TonAssetsManifestVersionCopyWith(_TonAssetsManifestVersion value, $Res Function(_TonAssetsManifestVersion) _then) = __$TonAssetsManifestVersionCopyWithImpl;
@override @useResult
$Res call({
 int major, int minor, int patch
});
