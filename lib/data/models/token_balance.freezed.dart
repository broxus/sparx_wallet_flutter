...
extension TokenBalanceModelPatterns on TokenBalanceModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TokenBalanceModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String amount, Address ownerAddress, Address rootAddress,
            Address tokenWalletAddress, String token)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TokenBalanceModel() when $default != null:
        return $default(_that.amount, _that.ownerAddress, _that.rootAddress,
            _that.tokenWalletAddress, _that.token);
      case _:
        return orElse();
    }
  }
