...
mixin _$AccountBalanceModel {
 ...
 Address get rootTokenContract;@moneyFromStringJsonConverter Money get fiatBalance;@moneyFromStringJsonConverter Money get tokenBalance;@JsonKey(defaultValue: false) bool get isNative;
...
@useResult
$Res call({
 Address rootTokenContract,@moneyFromStringJsonConverter Money fiatBalance,@moneyFromStringJsonConverter Money tokenBalance,@JsonKey(defaultValue: false) bool isNative
});
...
/// Create a copy of AccountBalanceModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? rootTokenContract = null,Object? fiatBalance = null,Object? tokenBalance = null,Object? isNative = null,}) {
...
as Address,fiatBalance: null == fiatBalance ? _self.fiatBalance : fiatBalance // ignore: cast_nullable_to_non_nullable
as Money,tokenBalance: null == tokenBalance ? _self.tokenBalance : tokenBalance // ignore: cast_nullable_to_non_nullable
as Money,isNative: null == isNative ? _self.isNative : isNative // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of AccountBalanceModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Address rootTokenContract, @moneyFromStringJsonConverter  Money fiatBalance, @moneyFromStringJsonConverter  Money tokenBalance, @JsonKey(defaultValue: false)  bool isNative)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountBalanceModel() when $default != null:
return $default(_that.rootTokenContract,_that.fiatBalance,_that.tokenBalance,_that.isNative);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Address rootTokenContract, @moneyFromStringJsonConverter  Money fiatBalance, @moneyFromStringJsonConverter  Money tokenBalance, @JsonKey(defaultValue: false)  bool isNative)  $default,) {final _that = this;
switch (_that) {
case _AccountBalanceModel():
return $default(_that.rootTokenContract,_that.fiatBalance,_that.tokenBalance,_that.isNative);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Address rootTokenContract, @moneyFromStringJsonConverter  Money fiatBalance, @moneyFromStringJsonConverter  Money tokenBalance, @JsonKey(defaultValue: false)  bool isNative)?  $default,) {final _that = this;
switch (_that) {
case _AccountBalanceModel() when $default != null:
return $default(_that.rootTokenContract,_that.fiatBalance,_that.tokenBalance,_that.isNative);case _:
  return null;
...
class _AccountBalanceModel implements AccountBalanceModel {
  const _AccountBalanceModel({required this.rootTokenContract, @moneyFromStringJsonConverter required this.fiatBalance, @moneyFromStringJsonConverter required this.tokenBalance, @JsonKey(defaultValue: false) required this.isNative});
...
@override@moneyFromStringJsonConverter final  Money fiatBalance;
@override@moneyFromStringJsonConverter final  Money tokenBalance;
@override@JsonKey(defaultValue: false) final  bool isNative;
...
/// Create a copy of AccountBalanceModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? rootTokenContract = null,Object? fiatBalance = null,Object? tokenBalance = null,Object? isNative = null,}) {
