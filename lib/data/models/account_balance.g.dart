...
_AccountBalanceModel _$AccountBalanceModelFromJson(Map<String, dynamic> json) =>
    _AccountBalanceModel(
      ...
      fiatBalance: moneyFromStringJsonConverter.fromJson(
        json['fiatBalance'] as Map<String, dynamic>,
      ),
      tokenBalance: moneyFromStringJsonConverter.fromJson(
...
Map<String, dynamic> _$AccountBalanceModelToJson(
  ...
  'tokenBalance': moneyFromStringJsonConverter.toJson(instance.tokenBalance),
