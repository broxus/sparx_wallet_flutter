...
void main() {
  ...
  group('Migrate NetworkGroup', () {
    test(
      'Does not migrate any connections if there are no connections with group == custom',
      () async {
    ...
    test(
      'Migrates each custom connection: updates group to custom-10000/custom-10001 and copies custom/system assets to those groups',
      () async {
        // given
